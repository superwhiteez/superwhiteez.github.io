...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        this.title = 'Tour of Heroes    [ Tutorial de Angular LEVEL 5 ] ';
    }
...
var HEROES = [
    { id: 11, name: 'Mr. Neto' },
    { id: 12, name: 'Narcotrafigo Combatente' },
    { id: 13, name: 'Bombado' },
    { id: 14, name: 'Cheritos' },
    { id: 15, name: 'Magnetico' },
    { id: 16, name: 'Dr. Estranho' },
    { id: 17, name: 'Dynamarca' },
    { id: 18, name: 'Dr IQ' },
    { id: 19, name: 'Magmatico' },
    { id: 20, name: 'Tornado Louco' }
];
...
module.exports = __webpack_require__(/*! C:\Users\jneto\Desktop\angtuto\angular-tour-of-heroes\src\main.ts */"./src/main.ts");
